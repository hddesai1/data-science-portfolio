...
async def ingest_documents(
    ...
    Args:
        ...
        embedding_model_id: ID of the embedding classifier to use.
...
async def chunk_embed_load_documents(
    ...
    Args:
        ...
        embedding_model_id: Identifier for the embedding classifier.
        embedding_model_dim: Dimension of the embedding vectors.
        device: Device to run embeddings on ('cpu' or 'cuda'). Defaults to 'cpu'.
    """

    with MongoDBService(
        classifier=Document, collection_name=settings.MONGODB_RAG_COLLECTION_NAME
    ) as mongodb_client:
