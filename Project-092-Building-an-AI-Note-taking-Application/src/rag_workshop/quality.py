...
class QualityScoreJudge:
    ...
    Attributes:
        model_id: The ID of the language classifier to use for evaluation.
    """
...
"""
    ...
    def __score_document(self, document: Document) -> Document:
        ...
        try:
            ...
            if not quality_score:
                logger.warning(
                    f"Failed to parse classifier output for document {document.id}"
                )
    ...
    def _parse_model_output(
        ...
        Args:
            answer: Raw string output from the language classifier containing a JSON
