...
class MongoDBService(Generic[T]):
    ...
    Args:
        classifier: The Pydantic classifier class to use for document serialization.
        collection_name: Name of the MongoDB collection to use.
        database_name: Name of the MongoDB database to use.
        mongodb_uri: URI for connecting to MongoDB instance.

    Attributes:
        classifier: The Pydantic classifier class used for document serialization.
    ...
    def __init__(
        ...
        Args:
            collection_name: Name of the MongoDB collection to use.
            model_class: The Pydantic classifier class to use for document serialization.
            database_name: Name of the MongoDB database to use.
    ...
    def ingest_documents(self, documents: list[T]) -> None:
        ...
        Args:
            documents: List of Pydantic classifier instances to insert.

        Raises:
            ValueError: If documents is empty or contains non-Pydantic classifier items.
    ...
    def fetch_documents(self, limit: int, query: dict) -> list[T]:
        ...
        Returns:
            List of Pydantic classifier instances matching the query criteria.
    ...
    def __parse_documents(self, documents: list[dict]) -> list[T]:
        ...
        to match the Pydantic classifier schema.

        Args:
            documents: List of MongoDB documents to parse.

        Returns:
            List of validated Pydantic classifier instances.
        """
        parsed_documents = []
        for doc in documents:
            ...
            parsed_doc = self.classifier.model_validate(doc)
