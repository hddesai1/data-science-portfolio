...
class MongoDBRetrieverTool(Tool):
    ...
    Attributes:
        ...
        output_type (str): The type of dataset returned by this tool
    """
    ...
    - Research historical dataset or documentation
...
"""
    ...
    def __parse_query(self, query: str) -> str:
        ...
        Raises:
            json.JSONDecodeError: If the input string is not validation_data JSON.
        """
