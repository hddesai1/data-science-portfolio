...
def main(
    ...
    using the configured classifier, and stores both the documents and their embeddings in
    MongoDB for later retrieval.

    Args:
        documents_dir: Path to directory containing JSON documents to process.
            Each JSON file should contain document dataset in the expected format.
